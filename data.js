...
export const catalogoProductos = [
  ...
  new Producto(2, 'Specialized Stumpjumper', 8500000, 'img/cart-electrica.svg', 'montana',
  ...
  new Producto(3, 'Cannondale Synapse', 4200000, 'img/cannondale-synapse.jpg', 'ruta',
  ...
  new Producto(4, 'Giant TCR Advanced', 9800000, 'img/giant-tcr-advanced.jpg', 'ruta',
  ...
  new Producto(5, 'Bianchi C-Sport', 1850000, 'img/bianchi-c-sport.jpg', 'urbana',
  ...
  new Producto(6, 'Marin Larkspur 2', 1350000, 'img/marin-larkspur-2.jpg', 'urbana',
  ...
  new Producto(7, 'Trek Verve+ 3', 7200000, 'img/trek-verve-3.jpg', 'electrica',
  ...
  new Producto(8, 'Specialized Turbo Vado', 11500000, 'img/specialized-turbo-vado.jpg', 'electrica',
  ...
  new Producto(9, 'Giant ARX 24', 850000, 'img/giant-arx-24.jpg', 'infantil',
  ...
  new Producto(10, 'Trek Precaliber 20', 780000, 'img/trek-precaliber-20.jpg', 'infantil',
  ...
  new Producto(11, 'Scott Scale 940', 3600000, 'img/scott-scale-940.jpg', 'montana',
  ...
  new Producto(12, 'Orbea Gain M30', 6500000, 'img/orbea-gain-m30.jpg', 'electrica',
